            ...
            <div className=' container mx-auto px-6 md:px-12 xl:px-20 flex flex-col lg:flex-row items-center justify-between gap-12'>
                ...
                <div className=' w-full lg:flex-1 text-center lg:text-left'>
                    ...
                    <p className=' text-sm md:text-base lg:text-lg text-gray-600 mb-6'>
                        Our hobby is to fill your tummy with delicious food{" "}
                        <br className=' hidden sm:block' />
                        and with fast and free delavary.
                    ...
                    <div className=' flex flex-wrap justify-center lg:justify-start gap-4'>
                        ...
                        <button className=' flex items-center gap-2 group' onClick={() => setShowVideo(true)}>
                            <span className=' w-10 h-10 md:w-12 bg-red-500 rounded-full flex items-center justify-center transition group-hover:bg-red-600 group-hover:scale-110 shadow-lg relative'>
                    ...
                    <div className=' flex flex-col sm:flex-row items-center sm:items-center gap-4 mt6'>
                        ...
                        <div>
                            ...
                            <p className=' text-lg md:text-xl font-bold flex items-center'>
                                <span className=' text-yellow-500 mr-2'>&#x2605;&#x2605;</span>7.4k
                ...
                <div className=' w-full lg:flex-1 relative max-w-sm sm:max-w-md md:max-w-lg lg:max-w-none mx-auto '>
                    ...
                    <div className=' relative mx-auto'>
                        <img src={Bannerfood} alt="" className='w-full h-auto object-cover transform -rotate-180 hover:rotate-0 transition duration-500' />
                        ...
                        <div className=' relative '>
                            <img src={FireIcon} alt="" className=' w-10 sm:w-12 md:w-14 mb-20 sm:mb-32 md:mb-40' />
                            <img src={BannerArrow} alt="" className=' w-12 sm:w-16 md:w-20 transform rotate-30' />
                        </div>
